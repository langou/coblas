...
void cblas_dtbmv(CBLAS_ORDER order, CBLAS_UPLO uplo, CBLAS_TRANSPOSE trans, CBLAS_DIAG diag, int n, int k, double *A, int ldA, double *x, int incx)
{
    if((order!=CblasRowMajor)&&(order!=CblasColMajor))
        cblas_xerbla(1,"cblas_dtbmv","");
    else if((uplo!=CblasUpper)&&(uplo!=CblasLower))
        cblas_xerbla(2,"cblas_dtbmv","");
    else if((trans!=CblasNoTrans)&&(trans!=CblasTrans)&&(trans!=CblasConjTrans))
        cblas_xerbla(3,"cblas_dtbmv","");
    else if((diag!=CblasUnit)&&(diag!=CblasNonUnit))
        cblas_xerbla(4,"cblas_dtbmv","");
    else if(n<0)
        cblas_xerbla(5,"cblas_dtbmv","");
    else if(k<0)
        cblas_xerbla(6,"cblas_dtbmv","");
    else if(ldA<k+1)
        cblas_xerbla(8,"cblas_dtbmv","");
    else if(incx==0)
        cblas_xerbla(10,"cblas_dtbmv","");
    else
    {
