...
void cblas_dtrmv(CBLAS_ORDER order, CBLAS_UPLO uplo, CBLAS_TRANSPOSE trans, CBLAS_DIAG diag, int n, double *A, int ldA, double *x, int incx)
{
    if((order!=CblasRowMajor)&&(order!=CblasColMajor))
        cblas_xerbla(1,"cblas_dtrmv","");
    else if((uplo!=CblasUpper)&&(uplo!=CblasLower))
        cblas_xerbla(2,"cblas_dtrmv","");
    else if((trans!=CblasNoTrans)&&(trans!=CblasTrans)&&(trans!=CblasConjTrans))
        cblas_xerbla(3,"cblas_dtrmv","");
    else if((diag!=CblasUnit)&&(diag!=CblasNonUnit))
        cblas_xerbla(4,"cblas_dtrmv","");
    else if(n<0)
        cblas_xerbla(5,"cblas_dtrmv","");
    else if(ldA<n)
        cblas_xerbla(7,"cblas_dtrmv","");
    else if(incx==0)
        cblas_xerbla(9,"cblas_dtrmv","");
    else
    {
