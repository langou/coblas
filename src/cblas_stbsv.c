...
void cblas_stbsv(CBLAS_ORDER order, CBLAS_UPLO uplo, CBLAS_TRANSPOSE trans, CBLAS_DIAG diag, int n, int k, float *A, int ldA, float *x, int incx)
{
    if((order!=CblasRowMajor)&&(order!=CblasColMajor))
        cblas_xerbla(1,"cblas_stbsv","");
    else if((uplo!=CblasUpper)&&(uplo!=CblasLower))
        cblas_xerbla(2,"cblas_stbsv","");
    else if((trans!=CblasNoTrans)&&(trans!=CblasTrans)&&(trans!=CblasConjTrans))
        cblas_xerbla(3,"cblas_stbsv","");
    else if((diag!=CblasUnit)&&(diag!=CblasNonUnit))
        cblas_xerbla(4,"cblas_stbsv","");
    else if(n<0)
        cblas_xerbla(5,"cblas_stbsv","");
    else if(k<0)
        cblas_xerbla(6,"cblas_stbsv","");
    else if(ldA<k+1)
        cblas_xerbla(8,"cblas_stbsv","");
    else if(incx==0)
        cblas_xerbla(10,"cblas_stbsv","");
    else
    {
